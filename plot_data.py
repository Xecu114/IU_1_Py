...
def plot_ideal_functions(ideal_df):
    """_summary_
    The function takes the Pandas dataframe as input and
    returns line charts representing all columns of the dataframe. Each
    column is displayed in a different color and given its own label.
    Because the "ideal" dataset is so big, it is divided into 5 seperate
